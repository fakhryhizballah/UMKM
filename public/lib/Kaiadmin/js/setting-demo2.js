...
function customCheckColor() {
	...
	if (logoHeader !== "white") {
		$('.logo-header .navbar-brand').attr('src', '../asset/lib/Kaiadmin/img/kaiadmin/logo_light.svg');
	} else {
		$('.logo-header .navbar-brand').attr('src', '../asset/lib/Kaiadmin/img/kaiadmin/logo_dark.svg');
	}
}
